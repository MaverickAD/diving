...
function Home() {
  return (
    <div className="flex justify-center p-8 bg-white dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 mb-60 mt-16">
          ...
          <div className="mb-12 flex justify-center">
            <img src={plongeeImage} className="w-full max-w-full h-auto" alt="Plongee" />
          </div>
