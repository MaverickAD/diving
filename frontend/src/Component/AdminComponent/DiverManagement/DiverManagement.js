                ...
                {divers.length === 0 ? (
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-light-text text-center text-sm">
                            ...
                            <tr>
                                <th className="hidden md:table-cell w-9 px-1 py-2">ID</th>
                                <th className="w-28 px-1 py-2">First Name</th>
                                <th className="w-28 px-1 py-2">Last Name</th>
                                <th className="hidden md:table-cell w-28 px-1 py-2">
                                    Diver Qualification
                                </th>
                                <th className="hidden md:table-cell w-28 px-1 py-2">
                                ...
                                <th className="hidden md:table-cell w-32 px-1 py-2">
                            ...
                            {divers
                                ...
                                .filter((diver, index) => {
                                    if (currentPage === 1) {
                                        ...
                                        return (
                                            index >= dataPerPage && index < dataPerPage * 2
                                        );
                                    } else {
                                        return (
                                ...
                                .map((diver, index) => (
                                    <tr
                                        ...
                                        key={index}
                                    >
                                        <td className="hidden md:table-cell whitespace-nowrap w-9 px-1 py-2">
                                            {index + 1}
                                        </td>
                                        <td className="w-28 px-1 py-2">{diver.first_name}</td>
                                        <td className="w-28 px-1 py-2">{diver.last_name}</td>
                                        ...
                                        <td className="hidden md:table-cell w-32 px-1 py-2">
