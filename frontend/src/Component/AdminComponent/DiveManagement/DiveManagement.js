        ...
        <div className="overflow-x-hidden">
            <>
                ...
                <div className={"flex flex-col md:flex-row md:justify-between items-center mb-4"}>
                    <div className={"flex flex-col md:flex-row md:space-x-2 text-light-text text-sm"}>
                ...
                {openDives.length === 0 ? (
                    ...
                    <div className="overflow-x-auto">
                        <table className={"min-w-full text-light-text text-center text-sm"}>
                            ...
                            <tr>
                                <th className={"hidden md:table-cell w-28 px-1 py-2"}>ID</th>
                                <th className={"w-16 px-1 py-2"}>Status</th>
                                <th className={"w-32 px-1 py-2"}>Name</th>
                                <th className={"w-24 px-1 py-2"}>Begin Date</th>
                                <th className={"hidden md:table-cell w-28 px-1 py-2"}>End Date</th>
                                <th className={"hidden md:table-cell w-28 px-1 py-2"}>Comment</th>
                                <th className={"hidden md:table-cell w-28 px-1 py-2"}>Surface Security</th>
                                <th className={"hidden md:table-cell w-28 px-1 py-2"}>Number of place</th>
                                <th className={"hidden md:table-cell w-28 px-1 py-2"}>Registered place</th>
                                <th className={"hidden md:table-cell w-28 px-1 py-2"}>Dive Site</th>
                                <th className={" md:table-cell w-28 px-1 py-2"}>Security</th>
                            </tr>
                            </thead>
                            <tbody>
                            {openDives
                                ...
                                .map((dive, index) => (
                                    ...
                                    >
                                        <td
                                            className={"hidden md:table-cell whitespace-nowrap w-9 px-1 py-2"}
                                            onClick={() => {
                                        ...
                                        <td className={"hidden md:table-cell w-28 px-1 py-2"}>
                                            {new Date(dive.date_end).toISOString().slice(0, 10)}
                                        </td>
                                        <td
                                            className={"hidden md:table-cell w-28 px-1 py-2"}
                                            onClick={() => {
                                                navigate("/instructor/dive_management/" + dive.id);
                                            }}
                                        >
